...
import uk.nhs.ctp.service.report.decorator.mapping.template.informant.InformantTemplateResolver;
...
public class InformantDocumentDecorator implements OneOneOneDecorator {
	...
	@Autowired
	private InformantTemplateResolver<? extends IBaseResource> informantTemplateResolver;
