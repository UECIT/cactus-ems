...
@Component
public class ObservationToClinicalDiscriminatorDataMapper implements ComponentDataMapper<Observation> {
	...
	@Override
	public void map(Observation observation, POCDMT200001GB02ClassificationSection classificationSection) {
		...
		templateContent.setExtension("COCD_TP146092GB01#ClinicalDiscriminator");
		component.setContentId(templateContent);
		...
		classificationSection.getEntry().add(component);
	}
