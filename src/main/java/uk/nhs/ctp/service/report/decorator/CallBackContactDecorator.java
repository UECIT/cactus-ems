...
import uk.nhs.ctp.service.report.decorator.mapping.template.resolver.CallBackChoiceTemplateResolver;
...
public class CallBackContactDecorator implements AmbulanceDecorator {
	...
	@Autowired
	private CallBackChoiceTemplateResolver<? extends IBaseResource> callBackChoiceTemplateResolver;
	...
	private JAXBElement<POCDMT200001GB02Participant> CreateCallBackContact(ReportRequestDTO request) {
		POCDMT200001GB02Participant callBackContact = callBackChoiceTemplateResolver.resolve(
