...
import uk.nhs.ctp.service.report.decorators.author.AuthorDocumentDecorator;
import uk.nhs.ctp.service.report.decorators.component.mapping.BundleToSectionMapper;
import uk.nhs.ctp.service.report.decorators.component.mapping.ComponentDataResolver;
import uk.nhs.ctp.service.report.decorators.component.mapping.ReferralRequestToSectionMapper;
...
public class ComponentDocumentDecorator implements OneOneOneDecorator {
	...
	@Autowired
	private ComponentDataResolver<? extends Resource> componentDataResolver;
	...
	public void decorate(POCDMT200001GB02ClinicalDocument document, ReportRequestDTO request) {
		...
		componentDataResolver.resolve(resourceBundle, classificationSection);
