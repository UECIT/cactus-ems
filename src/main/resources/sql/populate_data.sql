...
VALUES
 ('admin', 'Admin User', '$2a$10$hbxecwitQQ.dDT4JOFzQAulNySFwEpaFLw38jda6Td.Y/cOiRzDFu', true, 'ROLE_ADMIN', 'admin');

INSERT INTO
 cdss_decoupling.cdss_supplier (id, name, base_url) 
VALUES
 (1, 'CDSS Stub', 'https://cdss.cactus-staging.iucdspilot.uk/fhir/'),
